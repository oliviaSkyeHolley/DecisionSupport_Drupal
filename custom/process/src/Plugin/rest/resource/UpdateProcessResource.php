 ...
 *   uri_paths = {
 *     "canonical" = "/api/update-process-resource/{id}",
 *     "create" = "/api/update-process-resource"
 *   }
 * )
 *
 * @DCG
...
final class UpdateProcessResource extends ResourceBase {
  ...
  public function post(array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('Created new update process record @id.', ['@id' => $data['id']]);
  ...
  public function patch($id, array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('The update process record @id has been updated.', ['@id' => $id]);
  ...
  public function delete($id): ModifiedResourceResponse {
    ...
    $this->logger->notice('The update process record @id has been deleted.', ['@id' => $id]);

 ...
 *   uri_paths = {
 *     "canonical" = "/api/post-investigation-resource/{id}",
...
final class PostInvestigationResource extends ResourceBase {
  ...
  public function post(array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('Created new post investigation record @id.', ['@id' => $data['id']]);
  ...
  public function patch($id, array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('The post investigation record @id has been updated.', ['@id' => $id]);
  ...
  public function delete($id): ModifiedResourceResponse {
    ...
    $this->logger->notice('The post investigation record @id has been deleted.', ['@id' => $id]);
